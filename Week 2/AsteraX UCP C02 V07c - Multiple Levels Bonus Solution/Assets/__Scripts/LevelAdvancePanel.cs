...
public class LevelAdvancePanel : MonoBehaviour
{
    ...
    void SetState(eLevelAdvanceState newState)
    {
        ...
        switch (newState)
        {
            ...
            case eLevelAdvanceState.fadeIn:
                ...
                infoText.text = "Asteroids: " + lvlInfo.numInitialAsteroids 
                    + "\tChildren: " + lvlInfo.numSubAsteroids;
                // Set initial state
    ...
    // Update is called once per frame if GameObject is active and enabled == true
    void Update()
    {
    ...
    static public void AdvanceLevel(AsteraX.CallbackDelegate displayCB, 
                                    AsteraX.CallbackDelegate idleCB)
    {
        if (S == null)
        {
